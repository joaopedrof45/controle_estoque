      ...
      <div style="padding:20px 0" class="container">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            $sql = "SELECT id,data_ex,descricao,data_ini FROM garantia where id<>0";
            ...
            ?>
              <tr class="principal" text align='center'>
               ...
               <td class="principal" text align='center'>
                ...
                <td><a class="btn-editar btn btn-sm btn-warning" href="editar_almox.php?id=<?= $id ?>" role="button"><i class="far fa-edit"></i> &nbspEditar&nbsp</a>

                  <a class="btn-editar btn btn-sm btn-danger" href="excluir_almox.php?id=<?= $id ?>" role="button"><i class="far fa-trash-alt"></i> Excluir</a></td>
              </tr>
            <?php } ?>
